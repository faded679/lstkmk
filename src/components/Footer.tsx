      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="https://vk.com/mcsteel31" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-400 hover:text-[#0077FF] hover:bg-[#0077FF]/10 transition-colors" title="ВКонтакте">
              <VkIcon />
            </a>
            <a href="https://www.youtube.com/@mcsteel31" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-400 hover:text-[#FF0000] hover:bg-[#FF0000]/10 transition-colors" title="YouTube">
              <YouTubeIcon />
            </a>
          </div>
