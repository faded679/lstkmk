...
export default function LandingPage() {
  ...
  const priceTable = [
    { type: "Холодный ангар (профлист)", price: "от 4 500 ₽/м²", desc: "Каркас ЛСТК, ограждение, кровля, ворота" },
    { type: "Тёплый склад (сэндвич 100 мм)", price: "от 5 600 ₽/м²", desc: "Утеплённый контур, ворота, фундамент*" },
    { type: "Производственный цех", price: "от 5 600 ₽/м²", desc: "Усиленный каркас, кран-балка, инженерия" },
    { type: "Автосервис / СТО", price: "от 4 800 ₽/м²", desc: "Тёплый ангар, ворота под погрузчик, полы" },
    { type: "Сельхозангар", price: "от 4 600 ₽/м²", desc: "Каркас, кровля, ограждение, ворота" },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Рассчитайте стоимость ангара под ключ за квадратный метр. Цены от 4 500 ₽/м². Холодные, тёплые, производственные — под ваш бюджет и задачу.
              </p>
