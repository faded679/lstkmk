...
export const metadata: Metadata = {
  ...
  description:
    "Строительство ангаров в Белгороде под ключ: проектирование, производство, монтаж. Цены за м² от 4 500 ₽. Узнайте стоимость и сроки — оставьте заявку.",
  keywords: [
...
export default function LandingPage() {
  ...
  const priceTable = [
    { type: "Холодный ангар", price: "от 4 500 ₽/м²", includes: "Каркас ЛСТК, профлист, кровля" },
    { type: "Тёплый склад", price: "от 5 600 ₽/м²", includes: "Сэндвич-панели, ворота, утепление" },
    { type: "Ангар с кран-балкой", price: "от 4 800 ₽/м²", includes: "Усиленный каркас, кран, монтаж" },
    { type: "Сельхозангар", price: "от 4 600 ₽/м²", includes: "Каркас, кровля, ограждение" },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем, производим и монтируем ангары, склады и быстровозводимые здания в Белгороде и Белгородской области. Цены от 4 500 ₽/м², срок от 45 дней, гарантия 5 лет.
              </p>
