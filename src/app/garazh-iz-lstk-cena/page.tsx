...
export const metadata: Metadata = {
  ...
  description:
    "Стоимость гаража из ЛСТК в 2026 году. Цены от 15 000 ₽/м², срок от 2 недель. Гараж на 1, 2 машины, мастерская, с навесом. Проект, фундамент, монтаж, гарантия 5 лет.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Цены от 15 000 ₽/м², срок от 2 недель. Гараж на 1, 2 машины, мастерская, с навесом.",
...
export default function GarazhLandingPage() {
  ...
  const types = [
    { title: "Холодный гараж", price: "от 15 000 ₽/м²", desc: "Для хранения автомобиля и инструментов. Профлист, без утепления, минимальная цена." },
    { title: "Тёплый гараж с отоплением", price: "от 22 000 ₽/м²", desc: "Сэндвич-панели, утепление, электрика, отопление. Комфортная работа зимой." },
    { title: "Гараж-СТО с ямой", price: "от 25 000 ₽/м²", desc: "Смотровая яма, подъёмник или эстакада, усиленный пол, вентиляция." },
    { title: "Гаражный комплекс", price: "от 14 000 ₽/м²", desc: "Несколько боксов, навес, общая крыша. Экономия за счёт масштаба." },
  ];
  ...
  const cases = [
    { title: "Холодный гараж 6×4 м", place: "Белгород", area: 24, term: "14 дней", price: "380 000 ₽" },
    { title: "Тёплый гараж на 2 машины 8×6 м", place: "Воронеж", area: 48, term: "21 день", price: "750 000 ₽" },
    { title: "Утеплённая гараж-мастерская 10×8 м", place: "Курск", area: 80, term: "28 дней", price: "1 100 000 ₽" },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Строим гаражи из лёгких стальных тонкостенных конструкций. От проекта до сдачи за 2-3 недели. Цены от 15 000 ₽/м². Гарантия 5 лет.
              </p>
