...
export const metadata: Metadata = {
  ...
  description:
    "Проектирование, производство и монтаж металлоконструкций в ДНР. Ангары, склады, сельхозздания и объекты восстановления. Цены от 12 000 ₽/м². Узнайте стоимость — оставьте заявку.",
  keywords: [
    "металлоконструкции в ДНР",
    "металлоконструкции ДНР цена",
    "производство металлоконструкций ДНР",
    "монтаж металлоконструкций ДНР",
    "ангары ДНР",
    "склады ДНР",
    "ЛСТК ДНР",
  ],
  openGraph: {
    title: "Металлоконструкции в ДНР под ключ цена",
    description: "Металлоконструкции в ДНР: ангары, склады, сельхозздания, восстановление. Цены, сроки, гарантия. Заявка онлайн.",
    url: "https://lstkmk.ru/metallokonstrukcii-dnr/",
  },
  alternates: {
    canonical: "https://lstkmk.ru/metallokonstrukcii-dnr/",
  },
};
...
export default function LandingPage() {
  const localBusinessSchema = {
    ...
    description: "Проектирование, производство и монтаж металлоконструкций, складов, ангаров и объектов восстановления в ДНР.",
    url: "https://lstkmk.ru/metallokonstrukcii-dnr/",
  ...
  const advantages = [
    { title: "Собственное производство", text: "Завод в Белгородском районе. Собственный цех резки, сверления и грунтовки металлоконструкций. Доставка в ДНР — согласованные сроки." },
    { title: "Проектирование и согласование", text: "Разделы КМ, КМД, АР, ЭМ. Помогаем с разрешительной документацией для объектов в ДНР." },
  ...
  const steps = [
    { step: 1, title: "Заявка и замер", text: "Оставляете заявку, инженер выезжает на площадку в ДНР бесплатно." },
    ...
    { step: 4, title: "Доставка и монтаж", text: "Доставляем конструкции в ДНР, собираем каркас на вашем участке." },
  ...
  const cities = [
    "Донецк", "Макеевка", "Горловка", "Енакиево", "Харцызск", "Шахтёрск", "Ясиноватая", "Докучаевск", "Амвросиевка", "Снежное"
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                Металлоконструкции в ДНР под ключ
              </h1>
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем, производим и монтируем металлоконструкции для складов, ангаров, сельхозобъектов и восстановления в ДНР. Цены от 12 000 ₽/м², срок от 45 дней, гарантия 5 лет.
              </p>
            ...
            <div className="space-y-16">
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                  Металлоконструкции в ДНР — проект, цена, монтаж
                </h2>
                <p className="text-muted leading-relaxed mb-4">
                  МАКСТИЛ производит металлоконструкции для объектов в ДНР с 2012 года. Работаем со складами, ангарами, сельхоззданиями, зернохранилищами, производственными цехами и объектами восстановления. Собственное производство металлоконструкций ЛСТК позволяет контролировать качество и сроки на каждом этапе.
                </p>
                <p className="text-muted leading-relaxed">
                  Для ДНР учитываем снеговую и ветровую нагрузки, типы грунтов и особенности эксплуатации в сельхозсекторе. Конструкции адаптируем под быстрое возведение и минимальные сроки.
                </p>
              </section>
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                  Стоимость металлоконструкций в ДНР
                </h2>
            ...
            <aside className="lg:sticky lg:top-28 h-fit">
              <div className="p-6 rounded-2xl border border-border bg-slate-50">
                ...
                <p className="text-sm text-muted mb-5">
                  Оставьте номер — инженер перезвонит, уточнит задачу и рассчитает стоимость под ваш объект в ДНР.
                </p>
                <a
                  href="tel:+79803211542"
        ...
        <section className="bg-slate-900 text-white py-16 lg:py-20">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Рассчитайте стоимость металлоконструкций в ДНР
            </h2>
