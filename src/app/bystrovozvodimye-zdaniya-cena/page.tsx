...
export default function LandingPage() {
  ...
  const priceTable = [
    { type: "Холодный ангар", price: "от 12 000 ₽/м²", desc: "Каркас ЛСТК, профлист, кровля, ворота" },
    { type: "Тёплый склад", price: "от 18 000 ₽/м²", desc: "Сэндвич-панели, утепление, ворота" },
    { type: "Производственный цех", price: "от 24 000 ₽/м²", desc: "Усиленный каркас, краны, инженерия" },
    { type: "Автосервис / СТО", price: "от 22 000 ₽/м²", desc: "Тёплый контур, ворота, полы" },
    { type: "Сельхозздание", price: "от 11 000 ₽/м²", desc: "Каркас, кровля, ограждение, вентиляция" },
    { type: "Торговый павильон / магазин", price: "от 20 000 ₽/м²", desc: "Тёплый контур, витрины, отделка" },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Строим быстровозводимые здания из металлоконструкций ЛСТК. Цены от 11 000 ₽/м², срок от 45 дней. Ангары, склады, цеха, автосервисы — под ключ.
              </p>
