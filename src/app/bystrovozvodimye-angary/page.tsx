...
export const metadata: Metadata = {
  ...
  description:
    "Строим быстровозводимые ангары из ЛСТК под ключ. Срок от 2 недель. Цены от 10 000 ₽/м². Холодные, тёплые, с кран-балкой, сельхоз. Работаем по всей России.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Срок от 2 недель, цены от 10 000 ₽/м². Холодные, тёплые, сельхоз и производственные ангары.",
...
export default function BystrovozvodimyeAngaryPage() {
  ...
  const sizes = [
    { size: "12×24 м", area: 288, price: "от 2 880 000 ₽" },
    { size: "15×30 м", area: 450, price: "от 4 500 000 ₽" },
    { size: "18×36 м", area: 648, price: "от 6 480 000 ₽" },
    { size: "20×40 м", area: 800, price: "от 8 000 000 ₽" },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем и строим быстровозводимые ангары любого назначения. Срок строительства — от 2 недель. Цены от 10 000 ₽/м². Работаем по всей России.
              </p>
