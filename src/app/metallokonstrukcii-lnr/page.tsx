...
export const metadata: Metadata = {
  title: "Металлоконструкции в ЛНР под ключ цена | МАКСТИЛ",
  description:
    "Проектирование, производство и монтаж металлоконструкций в ЛНР. Ангары, склады, сельхозздания и объекты восстановления. Цены от 12 000 ₽/м². Узнайте стоимость — оставьте заявку.",
  keywords: [
    "металлоконструкции в ЛНР",
    "металлоконструкции ЛНР цена",
    "производство металлоконструкций ЛНР",
    "монтаж металлоконструкций ЛНР",
    "ангары ЛНР",
    "склады ЛНР",
    "ЛСТК ЛНР",
  ],
  openGraph: {
    title: "Металлоконструкции в ЛНР под ключ цена",
    description: "Металлоконструкции в ЛНР: ангары, склады, сельхозздания, восстановление. Цены, сроки, гарантия. Заявка онлайн.",
    url: "https://lstkmk.ru/metallokonstrukcii-lnr/",
  },
  alternates: {
    canonical: "https://lstkmk.ru/metallokonstrukcii-lnr/",
  },
};
...
export default function LandingPage() {
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    name: "МАКСТИЛ — металлоконструкции в ЛНР",
    description: "Проектирование, производство и монтаж металлоконструкций, складов, ангаров и объектов восстановления в ЛНР.",
    url: "https://lstkmk.ru/metallokonstrukcii-lnr/",
  ...
  const advantages = [
    { title: "Собственное производство", text: "Завод в Белгородском районе. Собственный цех резки, сверления и грунтовки металлоконструкций. Доставка в ЛНР — согласованные сроки." },
    { title: "Проектирование и согласование", text: "Разделы КМ, КМД, АР, ЭМ. Помогаем с разрешительной документацией для объектов в ЛНР." },
    { title: "Опыт восстановительного строительства", text: "Работаем с объектами, требующими быстрого возведения и минимальных сроков." },
  ...
  const steps = [
    { step: 1, title: "Заявка и замер", text: "Оставляете заявку, инженер выезжает на площадку в ЛНР бесплатно." },
    ...
    { step: 4, title: "Доставка и монтаж", text: "Доставляем конструкции в ЛНР, собираем каркас на вашем участке." },
  ...
  const objects = [
    ...
    { name: "Ангары", desc: "Для техники, грузовых автомобилей, материалов, зерна." },
    { name: "Коровники", desc: "С вентиляцией, утеплением и системами навозоудаления." },
    { name: "Сельхозпостройки", desc: "Зернохранилища, фермы, хранение техники." },
    { name: "Объекты восстановления", desc: "Быстровозводимые здания для инфраструктуры и жизнеобеспечения." },
  ];

  const cities = [
    "Луганск", "Краснодон", "Алчевск", "Свердловск", "Ровеньки", "Стаханов", "Брянка", "Кировск", "Первомайск", "Снежное"
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                Металлоконструкции в ЛНР под ключ
              </h1>
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем, производим и монтируем металлоконструкции для складов, ангаров, сельхозобъектов и восстановления в ЛНР. Цены от 12 000 ₽/м², срок от 45 дней, гарантия 5 лет.
              </p>
            ...
            <div className="space-y-16">
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                  Металлоконструкции в ЛНР — проект, цена, монтаж
                </h2>
                <p className="text-muted leading-relaxed mb-4">
                  МАКСТИЛ производит металлоконструкции для объектов в ЛНР с 2012 года. Работаем со складами, ангарами, сельхоззданиями, зернохранилищами, производственными цехами и объектами восстановления. Собственное производство металлоконструкций ЛСТК позволяет контролировать качество и сроки на каждом этапе.
                </p>
                <p className="text-muted leading-relaxed">
                  Для ЛНР учитываем снеговую и ветровую нагрузки, типы грунтов и особенности эксплуатации в сельхозсекторе. Конструкции адаптируем под быстрое возведение и минимальные сроки.
                </p>
              </section>
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                  Стоимость металлоконструкций в ЛНР
                </h2>
              ...
              <section>
                ...
                <p className="text-muted leading-relaxed mb-4">
                  Производим и монтируем металлоконструкции в городах и районах:
                </p>
            ...
            <aside className="lg:sticky lg:top-28 h-fit">
              <div className="p-6 rounded-2xl border border-border bg-slate-50">
                ...
                <p className="text-sm text-muted mb-5">
                  Оставьте номер — инженер перезвонит, уточнит задачу и рассчитает стоимость под ваш объект в ЛНР.
                </p>
                <a
                  href="tel:+79803211542"
        ...
        <section className="bg-slate-900 text-white py-16 lg:py-20">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Рассчитайте стоимость металлоконструкций в ЛНР
            </h2>
            <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
              Оставьте заявку — инженер МАКСТИЛ рассчитает проект, металлоконструкции, фундамент и монтаж под ваш объект. Бесплатный выезд на площадку.
            </p>
