...
export const metadata: Metadata = {
  title: "Металлоконструкции в Липецке и области под ключ | МАКСТИЛ",
  description:
    "Проектирование, производство и монтаж металлоконструкций в Липецке и Липецкой области. Цены от 12 000 ₽/м². Узнайте стоимость и сроки — оставьте заявку.",
  keywords: [
    "металлоконструкции в Липецке",
    "металлоконструкции Липецк цена",
    "металлоконструкции Липецкая область",
    "производство металлоконструкций Липецк",
    "монтаж металлоконструкций Липецк",
    "ЛСТК Липецк",
  ],
  openGraph: {
    title: "Металлоконструкции в Липецке и области под ключ цена",
    description: "Металлоконструкции в Липецке и Липецкой области. Цены, сроки, гарантия. Заявка онлайн.",
    url: "https://lstkmk.ru/metallokonstrukcii-lipeck/",
  },
  alternates: {
    canonical: "https://lstkmk.ru/metallokonstrukcii-lipeck/",
  },
};
...
export default function LandingPage() {
  const localBusinessSchema = {
    ...
    areaServed: "Липецк, Липецкая область, ЦФО, РФ",
  ...
  const advantages = [
    { title: "Собственное производство", text: "Завод в Белгородском районе. Собственный цех резки, сверления и грунтовки металлоконструкций. Доставка в Липецкую область — 1–2 дня." },
    { title: "Проектирование и согласование", text: "Разделы КМ, КМД, АР, ЭМ. Помогаем с разрешительной документацией в Липецке." },
    { title: "Монтаж бригадами из региона", text: "Знаем грунты, ветровой и снеговой районы Липецкой области. Работаем круглый год." },
  ...
  const steps = [
    { step: 1, title: "Заявка и замер", text: "Оставляете заявку, инженер выезжает на площадку в Липецке или области бесплатно." },
    ...
    { step: 4, title: "Доставка и монтаж", text: "Доставляем конструкции в Липецкую область, собираем каркас на вашем участке." },
  ...
  const cities = [
    "Липецк", "Елец", "Грязи", "Данков", "Лебедянь", "Усмань", "Чаплыгин", "Задонск", "Кривополье", "Тербуны"
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              <span className="inline-block px-3 py-1 rounded-full bg-accent-blue/20 text-accent-blue-light text-sm font-medium mb-6">
                Металлоконструкции в Липецке и области
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                Металлоконструкции в Липецке под ключ
              </h1>
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем, производим и монтируем металлоконструкции для складов, ангаров, цехов и сельхозобъектов в Липецке и Липецкой области. Цены от 12 000 ₽/м², срок от 45 дней, гарантия 5 лет.
              </p>
            ...
            <div className="space-y-16">
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                  Металлоконструкции в Липецке — проект, цена, монтаж
                </h2>
                <p className="text-muted leading-relaxed mb-4">
                  МАКСТИЛ производит металлоконструкции для объектов в Липецке и Липецкой области с 2012 года. Работаем со складами, ангарами, сельхоззданиями, производственными цехами, автосервисами и СТО. Собственное производство металлоконструкций ЛСТК позволяет контролировать качество и сроки на каждом этапе.
                </p>
                <p className="text-muted leading-relaxed">
                  Для Липецкой области учитываем снеговой район III, ветровой район II, глубину промерзания 1,0–1,2 м и типы грунтов. Это влияет на проектирование каркаса, фундамента и креплений, поэтому типовые решения адаптируем под каждый участок.
                </p>
              </section>
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                  Стоимость металлоконструкций в Липецке
                </h2>
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">
                  Какие объекты мы строим в Липецкой области
                </h2>
              ...
              <section>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                  Работаем по всей Липецкой области
                </h2>
                <p className="text-muted leading-relaxed mb-4">
                  Выезд инженера на площадку — бесплатно в радиусе 150 км от Липецка. Производим и монтируем металлоконструкции в городах и районах:
                </p>
        ...
        <section className="bg-slate-900 text-white py-16 lg:py-20">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Рассчитайте стоимость металлоконструкций в Липецке
            </h2>
