...
export const metadata: Metadata = {
  ...
  description:
    "Строим склады из металлоконструкций под ключ. Проектирование, фундамент, каркас ЛСТК, сэндвич-панели. Цены от 14 000 ₽/м². Расчёт онлайн.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Склады из металлоконструкций под ключ. Проектирование, производство, монтаж. Цены от 14 000 ₽/м².",
...
export default function LandingPage() {
  ...
  const priceTable = [
    { type: "Склад холодный (профлист)", price: "от 14 000 ₽/м²", desc: "Каркас ЛСТК, кровля, ворота" },
    { type: "Склад тёплый (сэндвич 100 мм)", price: "от 18 000 ₽/м²", desc: "Утепление, ворота, окна" },
    { type: "Склад класса А", price: "от 24 000 ₽/м²", desc: "Повышенная теплоизоляция, освещение, пожарная безопасность" },
    { type: "Склад с кран-балкой", price: "от 22 000 ₽/м²", desc: "Усиленный каркас, подкрановые пути" },
    { type: "Мини-склад до 300 м²", price: "от 16 000 ₽/м²", desc: "Быстрый монтаж, минимальный фундамент" },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем и строим склады из металлоконструкций ЛСТК. Холодные, тёплые, класса А, с кран-балкой. От 14 000 ₽/м², срок от 45 дней.
              </p>
