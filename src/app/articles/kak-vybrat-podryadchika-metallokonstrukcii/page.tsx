...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "производители ЛСТК Черноземье",
    "ИЗЛК Рус",
    "Ангар-Рус",
    "БСК-Белгород",
    "ЗМК Старый Оскол",
    "Завод ЛСТК Липецк",
    "Стальные решения RUS",
    "Ангарсталь",
    "Коловрат",
    "Спецпрокат",
    "ЛСТКстройГрупп",
        ...
        <article>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted leading-relaxed mb-6">
              В Черноземье рынок ЛСТК представлен как федеральными сетями (ИЗЛК Рус, Ангар-Рус), так и локальными производителями — БСК-Белгород и Стальнофф в Белгороде, ЗМК в Старом Осколе, Технология в Курске, Эксергия в Воронеже, Завод ЛСТК, Стальные решения RUS и Ангарсталь в Липецке, Ангар 48 в Орле. В Московском регионе активны Спецпрокат, Коловрат, ЛСТКстройГрупп и Евраз Стил Бокс. Компания МАКСТИЛ также работает в этом сегменте — собственное производство в Белгородской области, 14 лет на рынке, строительство под ключ.
            </p>
