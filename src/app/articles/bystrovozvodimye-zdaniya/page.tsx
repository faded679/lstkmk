        ...
        <article>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted leading-relaxed mb-6">
              Для большинства задач бизнеса — склада, производства, сельхозобъекта — ЛСТК является оптимальным выбором среди БВЗ: лучшее соотношение цены, пролётов, долговечности и возможности утепления. Срок строительства под ключ — 35–60 дней. Актуальные цены на быстровозводимые здания из металлоконструкций — на странице <Link href="/bystrovozvodimye-zdaniya-cena/" className="text-accent-blue hover:underline">быстровозводимые здания цена</Link>.
            </p>
          </div>
