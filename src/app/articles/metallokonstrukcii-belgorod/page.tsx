    ...
    <>
      ...
      <main className="pt-28 pb-24">
        <div className="max-w-[860px] mx-auto px-6 lg:px-10">
          ...
          <p className="text-base text-muted leading-relaxed mb-8">
            В регионе работают несколько производителей металлоконструкций: от федеральных сетей ИЗЛК Рус и Ангар-Рус до местных заводов — БСК-Белгород, Стальнофф, а также ЗМК в Старом Осколе. МАКСТИЛ — белгородский производитель с собственным заводом и штатным проектным бюро, строит объекты по области и Черноземью.
          </p>
