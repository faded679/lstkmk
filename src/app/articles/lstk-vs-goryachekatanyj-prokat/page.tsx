      ...
      <main className="max-w-[800px] mx-auto px-6 lg:px-10 pt-28 pb-20">
        ...
        <article>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-10 mb-4">
              Кто работает с ЛСТК и горячекатаным прокатом в Черноземье
            </h2>
            <p className="text-muted leading-relaxed mb-6">
              На ЛСТК специализируются федеральные сети ИЗЛК Рус и Ангар-Рус, а также локальные заводы: БСК-Белгород, Стальнофф (Белгород), Технология (Курск), Эксергия (Воронеж), Завод ЛСТК и Ангарсталь (Липецк), Ангар 48 (Орёл). Тяжёлым металлом и сварными конструкциями занимаются ЗМК в Старом Осколе, ЗСК Авангард и Стальные решения RUS в Липецке, Спецпрокат и Коловрат в Москве. МАКСТИЛ строит из ЛСТК в Белгородской области и соседних регионах — собственное производство, проектное бюро, монтажные бригады в штате.
            </p>
