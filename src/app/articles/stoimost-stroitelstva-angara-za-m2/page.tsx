      ...
      <main className="max-w-[800px] mx-auto px-6 lg:px-10 pt-28 pb-20">
        ...
        <article>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted leading-relaxed mb-6">
              В 2026 году стартовая цена холодного ангара начинается от 14 000 ₽/м², тёплого склада — от 22 000 ₽/м². Реальная стоимость определяется проектом и геологией. Лучший способ получить точную цифру — заказать предварительный расчёт по техническому заданию: это бесплатно и занимает 1–2 рабочих дня.
            </p>
          </div>
