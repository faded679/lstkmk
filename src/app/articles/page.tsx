...
const articles = [
  ...
  {
    id: 5,
    title: "Сколько стоит построить ангар в 2026 году",
    excerpt:
      "Актуальные цены на металлоконструкции, монтаж и материалы. Разбираем смету реального объекта площадью 3 000 м².",
    image: "https://images.unsplash.com/photo-1513467535987-fd81bc7d62f8?w=800&h=450&fit=crop",
    date: "5 апреля 2026",
    readTime: "10 мин",
    category: "Стоимость",
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=800&h=450&fit=crop",
    date: "20 марта 2026",
    readTime: "6 мин",
    category: "Технологии",
  },
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((article, i) => (
            <motion.article
              ...
              className="group rounded-lg border border-border bg-white hover:border-accent-blue/30 transition-all duration-300 overflow-hidden cursor-pointer"
            >
