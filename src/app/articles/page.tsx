...
const articles = [
  {
    ...
    image: "/knowledge/cow-farm-2.png",
    date: "16 июня 2026",
    readTime: "8 мин",
  ...
  },
  {
    ...
    image: "/knowledge/cow-farm-3.png",
    date: "16 июня 2026",
    readTime: "9 мин",
    category: "Сельхозздания",
  ...
  },
  {
    ...
    image: "/knowledge/cow-farm-1.png",
    date: "16 июня 2026",
    readTime: "10 мин",
    category: "Сельхозздания",
  ...
  {
    id: 501,
    title: "Панельный дом из ЛСТК: технология, цены, проекты",
    excerpt:
      "Строительство панельных домов из ЛСТК: технология, теплопотери, стоимость м². Быстровозводимые жилые и административные здания из лёгких стальных конструкций под ключ. От 18 000 ₽/м².",
    image: "/articles/chto-takoe-lstk.jpg",
    date: "25 июня 2026",
    readTime: "9 мин",
    category: "Технологии",
    slug: "panel-haus-iz-lstk",
  },
  {
    id: 502,
    title: "Склад для опасных грузов из металлоконструкций: требования и цены",
    excerpt:
      "Строительство складов для хранения ЛВЖ, ГЖ и химикатов из металлоконструкций. Взрывозащита, вентиляция, противопожарные мероприятия. Стоимость от 35 000 ₽/м².",
    image: "/articles/kak-vybrat-podryadchika-metallokonstrukcii.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Склады",
    slug: "sklad-dlya-opasnykh-gruzov",
  },
  {
    id: 503,
    title: "Ангар для птицеводства: птичник из металлоконструкций под ключ",
    excerpt:
      "Промышленные птичники из ЛСТК для бройлеров, несушек и индейки. Вентиляция, освещение, отопление. Размеры на 10 000–25 000 голов. Стоимость от 4 500 ₽/м².",
    image: "/articles/angar-dlya-selskogo-hozyajstva.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Сельхозздания",
    slug: "angar-dlya-pticevodstva",
  },
  {
    id: 504,
    title: "Кафе из металлоконструкций: быстровозводимое здание под ключ",
    excerpt:
      "Здание кафе из металлоконструкций за 60–90 дней. Пролёты без колонн до 24 м, панорамное остекление, вентиляция кухни. Стоимость от 22 000 ₽/м² под ключ.",
    image: "/articles/metallokonstrukcii-belgorod.jpg",
    date: "25 июня 2026",
    readTime: "7 мин",
    category: "Объекты",
    slug: "kafe-iz-metallokonstrukcij",
  },
  {
    id: 505,
    title: "Фасад из сэндвич-панелей: монтаж, цены, виды облицовки",
    excerpt:
      "Фасадные сэндвич-панели для промышленных, складских и торговых зданий. Виды панелей, горизонтальный и вертикальный монтаж, стоимость от 1 800 ₽/м².",
    image: "/articles/sandwich.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Материалы",
    slug: "fasad-iz-sendvich-panelej",
  },
  {
    id: 506,
    title: "Разборный ангар из металлоконструкций: цены, размеры, монтаж",
    excerpt:
      "Сборно-разборные ангары из металлоконструкций — временные укрытия для техники и стройматериалов. Монтаж за 3–7 дней без фундамента. Стоимость от 700 тыс ₽.",
    image: "/articles/sroki-stroitelstva-angara.jpg",
    date: "25 июня 2026",
    readTime: "7 мин",
    category: "Ангары",
    slug: "angar-razbornyj",
  },
  {
    id: 507,
    title: "Ферма для кроликов из металлоконструкций: строительство под ключ",
    excerpt:
      "Промышленные кролиководческие фермы из ЛСТК на 200–2 000 самок. Микроклимат, вентиляция, навозоудаление. Стоимость под ключ от 3,5 млн ₽.",
    image: "/articles/angar-dlya-selskogo-hozyajstva.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Сельхозздания",
    slug: "ferma-dlya-krolikov",
  },
  {
    id: 508,
    title: "Бытовка из металлоконструкций: размеры, цены, доставка",
    excerpt:
      "Металлические бытовки для строительных площадок и дач. Размеры 3–12 м, утепление, электрика, доставка. Стоимость от 85 000 ₽. Блок-контейнерные городки.",
    image: "/articles/stroitelnaya-ploshadka.jpg",
    date: "25 июня 2026",
    readTime: "6 мин",
    category: "Объекты",
    slug: "bytovka-iz-metallokonstrukcij",
  },
  {
    id: 509,
    title: "Ангар под автомойку из металлоконструкций: проект и цена",
    excerpt:
      "Металлокаркасный ангар на 2–6 постов для автомойки. Вентиляция, отопление, ЛОС, требования СанПиН. Стоимость от 2,5 млн ₽ на 2 поста под ключ.",
    image: "/articles/lstk-vs-goryachekatanyj-prokat.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Объекты",
    slug: "angar-pod-avtomojku",
  },
  {
    id: 510,
    title: "Теплица из металлоконструкций: промышленная, фермерская, цены",
    excerpt:
      "Промышленные теплицы из металлоконструкций под поликарбонат и стекло. Отопление, вентиляция, фундамент. Стоимость от 180 000 ₽ для фермера до 1,5 млн ₽ за га.",
    image: "/articles/angar-dlya-selskogo-hozyajstva.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Сельхозздания",
    slug: "teplica-iz-metallokonstrukcij",
  },
  {
    id: 511,
    title: "Сборка металлоконструкций: технология, этапы, типичные ошибки",
    excerpt:
      "Технология монтажа металлокаркаса: подготовка, последовательность этапов, допуски, типичные ошибки и контроль качества. Для ангара 1 000 м² — 7–10 дней работы бригады.",
    image: "/articles/montazh-metallokonstrukcij-hero.jpg",
    date: "25 июня 2026",
    readTime: "9 мин",
    category: "Строительство",
    slug: "sborka-metallokonstrukcij",
  },
  {
    id: 512,
    title: "Офис из металлоконструкций: быстровозводимое административное здание",
    excerpt:
      "Административные здания и офисы из металлоконструкций и ЛСТК. Строительство за 60–90 дней на 25–30% дешевле кирпича. Стоимость от 20 000 ₽/м² под чистовую отделку.",
    image: "/articles/metallokonstrukcii-belgorod-proekt.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Объекты",
    slug: "ofis-iz-metallokonstrukcij",
  },
  {
    id: 513,
    title: "Склад-холодильник из металлоконструкций: строительство под ключ",
    excerpt:
      "Холодильные склады и морозильники из металлоконструкций. ПУ-панели, защита пола от промерзания, холодильное оборудование. Стоимость от 15 000 ₽/м² (+4°С) до 22 000 ₽/м² (−18°С).",
    image: "/articles/uteplenie-bystrovozvodimogo-zdaniya.jpg",
    date: "25 июня 2026",
    readTime: "9 мин",
    category: "Склады",
    slug: "sklad-holodilnik",
  },
  {
    id: 514,
    title: "Промышленное здание из металлоконструкций: цехи, склады, производства",
    excerpt:
      "Производственные цеха и промышленные здания из металлоконструкций. Пролёты без опор до 36 м, высота до 12 м, кран-балка до 32 т. Стоимость от 8 000 ₽/м².",
    image: "/articles/montazh-fermy-vysota.jpg",
    date: "25 июня 2026",
    readTime: "9 мин",
    category: "Промышленные объекты",
    slug: "promyshlennoe-zdanie-lstk",
  },
  {
    id: 515,
    title: "Модульное здание из ЛСТК: быстровозводимые комплексы под ключ",
    excerpt:
      "Модульные здания из ЛСТК для жилья, офисов, производства и социальных объектов. Монтаж за 3–14 дней, мобильность, заводская сборка. Стоимость от 20 000 ₽/м².",
    image: "/articles/chto-takoe-lstk.jpg",
    date: "25 июня 2026",
    readTime: "8 мин",
    category: "Технологии",
    slug: "modulnoe-zdanie-iz-lstk",
  },
];
