...
const articles = [
  ...
  },
  {
    ...
    excerpt:
      "Разбор реальных ошибок при монтаже: перекосы колонн, проблемы со сваркой, контроль геометрии без дорогих приборов. Практические советы от инженеров с 14-летним опытом.",
