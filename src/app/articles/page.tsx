...
const articles = [
  {
    ...
    excerpt:
      "Сколько стоит ангар из металлоконструкций под ключ? Таблица цен для размеров 12×24, 18×36, 24×48, 30×60 м. Из чего складывается стоимость и как сэкономить без потери качества.",
    image: "/articles/lstk-vs-goryachekatanyj-prokat.jpg",
    date: "9 июня 2026",
    readTime: "10 мин",
    category: "Цены и стоимость",
    slug: "angar-iz-metallokonstrukcij-cena",
  },
  {
    id: 102,
    title: "Склад под ключ: стоимость строительства в 2025 году",
    excerpt:
      "Сколько стоит построить склад под ключ из металлоконструкций? Цены на склады 300, 600, 1200 м². Разбивка сметы по статьям, типы складов и сроки строительства.",
    image: "/articles/chto-takoe-lstk.jpg",
    date: "9 июня 2026",
    readTime: "9 мин",
    category: "Цены и стоимость",
    slug: "sklad-pod-klyuch-stoimost",
  },
  {
    id: 103,
    title: "Быстровозводимые здания: что это такое и сколько стоит",
    excerpt:
      "Полный обзор быстровозводимых зданий из металлоконструкций: технологии ЛСТК и горячекатаный прокат, виды объектов, сравнение с кирпичом и монолитом, цены 2025.",
    image: "/articles/sandwich.jpg",
    date: "9 июня 2026",
    readTime: "8 мин",
    category: "Технологии",
    slug: "bystrovozvodimye-zdaniya-chto-eto",
  },
  {
    id: 1,
