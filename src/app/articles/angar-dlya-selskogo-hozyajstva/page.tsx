      ...
      <main className="pt-28 pb-24">
        <div className="max-w-[860px] mx-auto px-6 lg:px-10">
          ...
          <div className="prose prose-slate max-w-none text-sm leading-relaxed text-foreground space-y-6">
            ...
            <p className="text-muted">
              Сельхозздание из ЛСТК площадью 1 000 м² строится за 45–60 дней под ключ. Стоимость холодного зернохранилища — от 4 600 ₽/м², утеплённого коровника — от 5 600 ₽/м². Сроки значительно короче, чем у кирпичных или блочных зданий аналогичного назначения.
            </p>
