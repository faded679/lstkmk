      ...
      <main className="max-w-[800px] mx-auto px-6 lg:px-10 pt-28 pb-20">
        ...
        <article>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-10 mb-4">
              Кто строит из ЛСТК в Черноземье
            </h2>
            <p className="text-muted leading-relaxed mb-6">
              Технологию ЛСТК в регионе применяют как федеральные сети — ИЗЛК Рус и Ангар-Рус с типовыми сериями зданий, так и локальные производители: БСК-Белгород и Стальнофф в Белгороде, ЗМК в Старом Осколе (тяжёлый и средний металл), Технология в Курске, Эксергия в Воронеже, Завод ЛСТК, Стальные решения RUS и Ангарсталь в Липецке, Ангар 48 в Орле. В Москве и Московской области — Спецпрокат, Коловрат, ЛСТКстройГрупп и Евраз Стил Бокс. МАКСТИЛ — белгородский производитель с собственным заводом, проектирует и строит здания ЛСТК под ключ по Черноземью.
            </p>
