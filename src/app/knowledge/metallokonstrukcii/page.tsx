      ...
      <main className="max-w-[800px] mx-auto px-6 py-12 pt-28">
        ...
        <article>
          ...
          <p className="text-sm text-muted mb-6">
            * Цены актуальны на 2025 год. Точная стоимость рассчитывается индивидуально по проекту с учётом региона, нагрузок и комплектации. Для Белгорода и области — смотрите актуальный прайс на странице <Link href="/metallokonstrukcii-belgorod-cena/" className="text-accent-blue hover:underline">металлоконструкции в Белгороде цена за тонну</Link>.
          </p>
