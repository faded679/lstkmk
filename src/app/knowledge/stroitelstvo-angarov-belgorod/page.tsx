    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-12 pt-28">
        ...
        <article>
          ...
          <p className="mb-4">
            Цены на строительство ангаров в Белгородской области соответствуют среднероссийским ориентирам. Холодный ангар — от <strong>4 500 ₽/м²</strong>, тёплый — от <strong>9 000 ₽/м²</strong>, производственный цех — от <strong>11 000 ₽/м²</strong>.
          </p>
