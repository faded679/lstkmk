    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-12 pt-28">
        ...
        <article>
          ...
          <p className="mb-4">
            Автосервис из ЛСТК под ключ стоит от <strong>9 000 ₽/м²</strong> за тёплый вариант и от <strong>11 000 ₽/м²</strong> с кран-балкой для шиномонтажа. В стоимость входят фундамент, каркас, утепление, кровля, ворота и монтаж.
          </p>
