...
export const metadata = {
  title: "Проектирование ангаров онлайн: бесплатный расчёт | ЛСТК МАКСТИЛ",
  description: "Проектирование ангаров онлайн: бесплатный расчёт. Профессиональное строительство ангаров из ЛСТК. Расчёт стоимости, проектирование, монтаж. Телефон: +7 (980) 321-15-42",
  keywords: ["ЛСТК", "ангар", "строительство", "цена", "проект", "монтаж", "сроки", "расчёт", "proektirovanie online"],
};
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: `
{
  ...
  "@type": "Article",
  "headline": "Проектирование ангаров онлайн: бесплатный расчёт стоимости и проекта ЛСТК",
  "description": "Бесплатный онлайн-расчёт ангара из ЛСТК за 15 минут. Цена от 6500 ₽/м², гарантия 50 лет, монтаж под ключ по всей России.",
  "author": {
    "@type": "Organization",
    "name": "ЛСТК МАКСТИЛ"
  },
