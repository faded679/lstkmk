...
export const metadata = {
  title: "Закон о строительстве ангаров 2024: что изменилось | ЛСТК МАКСТИЛ",
  description: "Закон о строительстве ангаров 2024: что изменилось. Профессиональное строительство ангаров из ЛСТК. Расчёт стоимости, проектирование, монтаж. Телефон: +7 (980) 321-15-42",
  keywords: ["ЛСТК", "ангар", "строительство", "цена", "проект", "монтаж", "сроки", "расчёт", "zakon stroitelstvo"],
};
...
<p>Несмотря на усиление требований, цена ангара ЛСТК осталась в диапазоне <strong>от 8 500 ₽/м²</strong>. Срок монтажа ангара 600 м² — 21–28 дней. Применение заводских комплектов с маркировкой деталей ускоряет сборку на 35% по сравнению с традиционным металлокаркасом.</p>

<h2>Вывод</h2>
<p>Закон 2024 года упростил согласование некапитальных ЛСТК-ангаров, но повысил требования к качеству проекта и материалов. МАКСТИЛ берёт на себя все этапы: от расчёта и проектирования до монтажа и регистрации.</p>
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: `
{
  ...
  "@type": "Article",
  "headline": "Закон о строительстве ангаров 2024: что изменилось",
  "description": "Обзор изменений в законодательстве 2024 года по строительству ангаров ЛСТК: уведомительный порядок, нормы огнестойкости, кадастровый учёт, цены и сроки монтажа.",
  "author": {
    "@type": "Organization",
    "name": "ЛСТК МАКСТИЛ"
  },
