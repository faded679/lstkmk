    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-12 pt-28">
        ...
        <article>
          ...
          <p className="mb-4">
            Холодный складской ангар стоит от <strong>4 500 ₽/м²</strong>, тёплый — от <strong>9 000 ₽/м²</strong>. Для хранения товаров, не требующих температурного режима, часто достаточно холодного варианта.
          </p>
