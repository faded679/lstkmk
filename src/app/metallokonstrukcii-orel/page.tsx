...
export const metadata: Metadata = {
  ...
  description:
    "Проектирование, производство и монтаж металлоконструкций в Орле и Орловской области. Цены от 4 500 ₽/м². Узнайте стоимость и сроки — оставьте заявку.",
  keywords: [
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем, производим и монтируем металлоконструкции для складов, ангаров, цехов и сельхозобъектов в Орле и Орловской области. Цены от 4 500 ₽/м², срок от 45 дней, гарантия 5 лет.
              </p>
