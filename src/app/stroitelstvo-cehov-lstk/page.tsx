...
export const metadata: Metadata = {
  ...
  description:
    "Проектируем и строим производственные цеха из ЛСТК под ключ. Цены от 12 000 ₽/м². Проект, фундамент, каркас, монтаж, сдача. Срок от 3 недель.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Производственные цеха из ЛСТК от 12 000 ₽/м². Проект, фундамент, каркас, монтаж, сдача.",
  ...
  const workshopTypes = [
    {
      ...
      desc: "Для лёгкой промышленности: сборка, упаковка, мелкосерийное производство. Высота 6–9 м, возможно размещение кран-балки. Цены от 12 000 ₽/м².",
    },
    {
      title: "Сборочный цех",
      desc: "Просторный пролёт без колонн для сборочных линий. Хорошая естественная и искусственная вентиляция. Цены от 14 000 ₽/м².",
    },
    {
      title: "Цех металлообработки",
      desc: "Усиленный каркас под станки, прессы, крановые нагрузки. Бетонные полы с армированием. Цены от 16 000 ₽/м².",
    },
    {
      title: "Столярный цех",
      desc: "Тёплый контур, пылеулавливание, сухой микроклимат. Подходит для деревообработки и мебельного производства. Цены от 15 000 ₽/м².",
    },
    {
      title: "Цех пищевого производства",
      desc: "Герметичные сэндвич-панели, моечные покрытия, вентиляция и кондиционирование. Соответствие санитарным нормам. Цены от 18 000 ₽/м².",
    },
    {
      title: "Ремонтный цех (СТО, автосервис)",
      desc: "Высота 5–7 м, ворота под грузовой и легковой транспорт, ямы, эстакады. Цены от 13 000 ₽/м².",
    },
  ];
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8">
                Проектируем и строим производственные цеха из лёгких стальных тонкостенных конструкций. Полный цикл: проект → фундамент → каркас → сдача. Цены от 12 000 ₽/м².
              </p>
